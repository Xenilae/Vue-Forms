...
export default {
  ...
  methods: {
    ...
    saveQuestion(question) {
      ...
      const questionIndex = this.questionList.findIndex((q) => q.id === question.id);
      if (questionIndex >= 0) {
        this.questionList.splice(questionIndex, 1, question);
      } else {
        this.questionList.push(JSON.parse(JSON.stringify(question)));
      }
